...
|프로젝트명|설명|기간|깃 링크|
|------------------|------------------------|---|-------------------------|
| 🏺 POT-FE | 효율적으로 업무를 수행할 수 있도록하는 그룹웨어 POT 프론트엔드 |2024.09.09 ~ 2024.11.06|[POT-프론트](https://github.com/34suuuuu/POT_fe)|
| 🏺 POT-BE | 효율적으로 업무를 수행할 수 있도록하는 그룹웨어 POT 백엔드 |2024.09.09 ~ 2024.11.06|[POT-백엔드](https://github.com/34suuuuu/POT_be)|
| ⏳ NoExit-FE | 방탈출 게임 검색/예약 및 커뮤니티 기능 통합 플랫폼 NoExit 프론트엔드 |2024.07.19 ~ 2024.09.06|[NoExit-프론트](https://github.com/34suuuuu/noexit-fe-aws)|
| ⏳ NoExit-BE | 방탈출 게임 검색/예약 및 커뮤니티 기능 통합 플랫폼 NoExit 백엔드 |2024.07.19 ~ 2024.09.06|[NoExit-백엔드](https://github.com/34suuuuu/NoExit-be)|
